...
export default function ReqWithdraw() {
  ...
  const { getUsers, getWithdraw, updateWithdraw, updateUser } =
    useContext(Context);
  ...
  const handleOpen = (userId, withdrawId) => {
    try {
  ...
  const handleUpdateBtn = () => {
    try {
      updateWithdraw(userId, withdrawId, state, reason);
